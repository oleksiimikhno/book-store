  ...
  describe 'POST /api/v1/products' do
    ...
    context 'when the product has meta texts' do
      ...
      it 'is the product has meta texts' do
        ...
        expect(product.meta_title).to eq(params[:product][:meta_title])
        expect(product.meta_description).to eq(params[:product][:meta_description])
      end

      it 'when meta_title below 20 symbols' do
        params[:product][:meta_title] = 'Throughout'
      ...
      it 'when meta_description below 60 symbols' do
        params[:product][:meta_description] = 'Throughout'
      ...
      it 'when meta_title above 120 symbols' do
        params[:product][:meta_title] = 'Throughout symbols Throughout symbols' * 5
      ...
      it 'when meta_description above 200 symbols' do
        params[:product][:meta_description] = 'Throughout symbols Throughout symbols' * 5
